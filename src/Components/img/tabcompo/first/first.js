    ...
    render() {
        return (
            ...
            <div className="col-6">
                <Card >
                    <CardBody>
                        <img src={bmw1} className="severity-content1" alt="bmw1"></img>
                        <Text><BoldText>Bmw 7 series</BoldText></Text> <hr></hr>
            ...
            <div className="col-6">
                <Card >
                    <CardBody>
                        <img src={bmw2} className="severity-content1" alt="bmw2"></img>
                        <Text><BoldText>Bmw 7 series again</BoldText></Text> <hr></hr>
                        <TextSmallSecondary style={{ marginTop: "-20px" }}>
                            <i className="fa fa-address-book"></i>
                            <span style={{ marginRight: "25px" }}>4 Seat</span>
                            <i className="fa fa-suitcase"></i>
