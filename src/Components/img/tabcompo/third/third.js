...
import lembo1 from "../../lembo1.jpg"
import lembo2 from "../../lembo2.jpg"
import '../tabcompo.css';
    ...
    render() {
        return (
            ...
            <div className="col-6">
                <Card >
                    <CardBody>
                        <img src={lembo1} className="severity-content1" alt="lembo1"></img>
                        <Text><BoldText>Lembo  series</BoldText></Text> <hr></hr>
            ...
            <div className="col-6">
                <Card >
                    <CardBody>
                        <img src={lembo2} className="severity-content1" alt="lembo2"></img>
                        <Text><BoldText>Lembo 7 series</BoldText></Text> <hr></hr>
                        <TextSmallSecondary style={{ marginTop: "-20px" }}>
                            <i className="fa fa-address-book"></i>
                            <span style={{ marginRight: "25px" }}>4 Seat</span>
                            <i className="fa fa-suitcase"></i>
